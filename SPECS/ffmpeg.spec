...
%define _with_nodist 1
%define _without_x264 0
...
%changelog
* Thu Apr 30 2015 Johnny Wang <johnnywang1991@msn.com> - 2.6.2-1
...
* Mon Feb 25 2002 Matthias Saou <matthias.saou@est.une.marmotte.net>
- Moved libavcodec.so to the main package to fix dependency problems.

* Tue Feb 19 2002 Matthias Saou <matthias.saou@est.une.marmotte.net>
- Major spec file updates, based on a very nice Mandrake spec.
- Revert to the 0.4.6 release as CVS snapshots don't build.

* Mon Feb  4 2002 Matthias Saou <matthias.saou@est.une.marmotte.net>
- Initial RPM release.
